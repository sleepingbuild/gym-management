        ...
        <table className="w-full text-body-sm">
          <thead>
            <tr className="border-b border-hairline">
              ...
              <th className="text-left py-3 text-muted font-medium">Cân nặng</th>
              ...
              <th className="text-right py-3 text-muted font-medium">Thao tác</th>
            </tr>
          </thead>
          <tbody>
            {records.map((record) => (
              <tr key={record.id} className="border-b border-hairline/50 hover:bg-surface-soft/50 transition-colors">
